import sys
sys.path.append(r'C:\Users\sigbj\Documents\Master\Code\heat')
import torch
...
def process_ImageNet(img):
    '''
    preprocessing for backbone trained on imagenet
    '''
...
def main(data_path, det_path, ckpt_path, viz_base, save_base, image_size=256, infer_times=3):
    ...
    for data_i, data in enumerate(test_dataloader):
        ...
        edges.append(pos_edges)
        ims.append(viz_image)
        pts.append(pred_corners_viz)
