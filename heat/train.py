...
class PlotLoss():
    ...
    def append_metrics(self,epoch, loss, metric):
        self.metrics.append(metric)
    
    def append_val_acc(self, val_acc):
    ...
    def plot(self):
        ...
        with open(r'C:\Users\sigbj\Documents\Master\Code\testing\test_output\metrics\metric{}.pkl'.format(self.epochs[-1]), 'wb') as file: 
...
def main():
    ...
    data_path = r'C:\Users\sigbj\Documents\Master\Code\testing\test_output'
    det_path = r'C:\Users\sigbj\Documents\Master\Code\testing\test_output\det'
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        plotloss['metrics'].append(train_stats)
        with open(r'C:\Users\sigbj\Documents\Master\Code\testing\test_output\metrics\metric{}.pkl'.format(epoch), 'wb') as file: 
            pickle.dump(plotloss, file)
        lr_scheduler.step()
        ...
        if args.output_dir:
            ...
            if is_best:
                checkpoint_paths.append(output_dir / 'checkpoint_best{}.pth'.format(epoch))
